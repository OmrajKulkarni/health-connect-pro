...
import { Stethoscope, MapPin, Star, Calendar, ArrowLeft, Search, IndianRupee, Loader2 } from "lucide-react";
...
const DoctorsList = () => {
  ...
  const { doctors, loading, error } = useDoctors(searchQuery, selectedRegion, sortBy);
